...
const ControlButton = ({
  ...
  const baseStyles = clsx(
    ...
    active && 'text-accent-400 bg-accent-400/10 border-accent-400/30'
  );
  ...
  return (
    <div className="absolute bottom-24 lg:bottom-6 left-1/2 -translate-x-1/2 lg:left-auto lg:right-6 lg:translate-x-0 flex items-center gap-3 z-50 p-2 rounded-2xl glass border-surface-800/30 pointer-events-auto">
      <ControlButton
        ...
        label={isAutoRotating ? 'Stop rotation' : 'Start rotation'}
      ...
      <ControlButton
        ...
        active={isFocusMode}
        label={isFocusMode ? 'Show UI' : 'Hide UI (Focus Mode)'}
